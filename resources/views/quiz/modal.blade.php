...
<div x-show="showEndTestModal" class="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
    <div class="bg-white p-6 rounded-lg shadow-lg w-96 text-center">
        ...
        <p class="mb-4 text-gray-700">Are you sure you want to end the quiz? <br> You will not be able to retake it later.</p>
        <div class="flex justify-center space-x-4">
            <button @click="showEndTestModal = false" class="bg-gray-500 hover:bg-gray-700 text-white py-2 px-4 rounded">
                Cancel
            </button>
            <button @click="confirmEndQuiz()" class="bg-red-500 hover:bg-red-700 text-white py-2 px-4 rounded">
                Confirm
            </button>
        </div>
    </div>
